...
<html>
  <head> 
    ...
    <title>Agric Price Advisor System</title>
        ...
        <div class="container-fluid d-flex align-items-center justify-content-between">
          <div class="navbar-header">
            <!-- Navbar Header--><a href="index.html" class="navbar-brand">
              <div class="brand-text brand-big visible text-uppercase"><strong class="text-primary">APAS</strong><strong>PROJECT</strong></div>
    ...
    <div class="d-flex align-items-stretch">
      ...
      <nav id="sidebar">
        ...
        <ul class="list-unstyled">
                ...
                <li><a href="tables.html"> <i class="icon-grid"></i>Predict</a></li>
